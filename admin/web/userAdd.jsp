    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="${pageContext.request.contextPath}/addUser" method="post" id="myform" name="myform">
                    <div style="padding-top: 30px; padding-left: 30px">
                        <p style="padding-left: 60px">
                            <span style="">用户ID：</span>
                            <input name="uid" size="50" type="text" placeholder="请输入用户ID" required>
                        </p>
                        <p style="padding-left: 47px;">
                            <span>用户姓名：</span>
                            <input name="uname" size="50" type="text" placeholder="请输入用户名" required>
                        </p>
                        <p style="padding-left: 47px;">
                            <span>登录密码：</span>
                            <input name="upassword" size="50" type="text" placeholder="请输入用户密码" required>
                        </p>
                        ...
                        <p style="padding-left: 47px;">
                            <span>电子邮箱：</span>
                            <input name="uemail" size="50" type="text" placeholder="请输入用户电子邮箱" required>
                        </p>
                        <p style="padding-left: 47px;">
                            <span>手机号码：</span>
                            <input name="uphone" size="50" type="text" placeholder="请输入用户手机号码" required>
                        </p>
                        <p style="padding-left: 47px;">
                            <span>收货地址：</span>
                            <input name="uaddress" size="50" type="text" placeholder="请输入用户收货地址" required>
                        </p>
                        <p style="padding-left: 47px;">
                            <span>用户权限：</span>
                            <input type="radio" name="ustatus" value="0" checked="checked"> 0&nbsp;&nbsp;
                            <input type="radio" name="ustatus" value="1"> 1
                            （1为管理员）
                        </p>
